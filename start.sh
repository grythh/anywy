...
UUID=${UUID:-'4d77e732-5904-432f-a09b-14d0ef077986'}
VMESS_WSPATH=${VMESS_WSPATH:-'/QyVfasyCcZEz5J4'}
VLESS_WSPATH=${VLESS_WSPATH:-'/j0SivnoB1xweFqQ'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/rqviPZA3e0wb5'}
SS_WSPATH=${SS_WSPATH:-'/GcN4S1jIP'}
